    ...
    try:
        ...
        while True:
            ...
            for message_counter in range(0, MESSAGE_COUNT):
                ...
                #instantiate plc here
                plc = plc_simulate.PLC("Kwinana", "Wheat", "900")

                dataout = plc.get_data(starttime)
                if dataout:
                    msg_txt_formatted = plc_simulate.MSG_TXT % dataout
                    
                # messages can be encoded as string or bytearray
                    logging.info(msg_txt_formatted)
                ...
                # optional: assign properties
                    ...
                    #prop_map.add("tphAlert", 'true' if TPH > 28 else 'false')
                    print("message is ###### %s " % message.get_string())
    ...
    try:
        ...
        while True:
            ...
            for message_counter in range(0, MESSAGE_COUNT):
                ...
                logging.info(msg_txt_formatted)
                logging.info((message_counter & 1) == 1)
                # messages can be encoded as string or bytearray
                if (message_counter & 1) == 1:
                    message = IoTHubMessage(bytearray(msg_txt_formatted, 'utf8'))
                else:
